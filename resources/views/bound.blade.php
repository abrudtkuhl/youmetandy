...
<body>
    <article class="page prose">
        ...
        <p>On the technical side, the things on my plate are the things on yours. Laravel Cloud runs on AWS and Cloudflare, and I'm working on hibernating compute pods, AI agents on ephemeral compute, APIs, SSO, and scalable managed queues for async jobs on dedicated compute. So when your posting talks about microservices evolution, AWS scaling, Docker/K8s, Postgres, that's adjacent to my Tuesday, not a stretch.</p>
